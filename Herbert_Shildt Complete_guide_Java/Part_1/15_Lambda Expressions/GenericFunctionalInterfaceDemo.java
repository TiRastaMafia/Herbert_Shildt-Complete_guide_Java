...
class GenericFunctionalInterfaceDemo {
    public static void main(String[] args){
        ...
        System.out.println("Строка Lambda с противоположным порядком символов: " + reverse.func("Lambda"));
        System.out.println("Строка Expression с противоположным порядком символов: " + reverse.func("Expression"));
