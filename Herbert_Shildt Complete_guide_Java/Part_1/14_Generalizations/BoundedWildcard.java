// Ограниценный аргумент с подстановочным знаком
...
// Демонстрация использования ограниценного 
...
class BoundedWildCard {
    ...
    public static void main(String[] args) {
        ...
        //showXYZ(tdlocs); //НОрмально это объект TwoD
        //showAll(tdlocs); //НОрмально это объект TwoD
